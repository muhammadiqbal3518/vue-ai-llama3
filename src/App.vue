...
<template>
  ...
  >
    ...
    >
      ...
      <label
        for="audio-upload"
        class="cursor-pointer flex items-center justify-center bg-gray-200 hover:bg-gray-300 text-gray-600 w-10 h-10 rounded-full"
        :disabled="audioFile || content"
      >
      ...
      <button
        ...
        :class="
          isRecording ? 'bg-red-500' : 'bg-gray-200 hover:bg-gray-300 text-gray-600'
        "
        class="flex items-center justify-center w-10 h-10 rounded-full"
      >
        <img v-if="!isRecording" src="../public/microphone.png" alt="Microphone" />
        <svg
          v-else
          xmlns="http://www.w3.org/2000/svg"
          class="w-6 h-6"
      ...
      >
        ...
        <img v-else src="../public/send.png" alt="Send" />
      </button>
      <div
        @click="cleanChat"
        v-if="chatHistory != ''"
